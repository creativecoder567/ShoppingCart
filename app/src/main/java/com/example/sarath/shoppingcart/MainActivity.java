package com.example.sarath.shoppingcart;
                    ...
                    firebaseUser.updateEmail(newEmail.getText().toString().trim())
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                               ...
                               if (task.isSuccessful()){
                                   Toast.makeText(MainActivity.this, "Email address is updated,please update with new email id", Toast.LENGTH_SHORT).show();
                                   signOut();
                                   progressBar.setVisibility(View.GONE);
                               }else {
            ...
            public void onClick(View v) {
                ...
                if (firebaseUser!=null && !newPassword.getText().toString().trim().equals("")){
                    if (newPassword.getText().toString().trim().length()<6){
                        newPassword.setError("password is short,Enter minimum 6 characters");
                        progressBar.setVisibility(View.GONE);
                    }else {
                        firebaseUser.updatePassword(newPassword.getText().toString().trim())
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            Toast.makeText(MainActivity.this, "password is updated,signin with new password", Toast.LENGTH_SHORT).show();
                                            signOut();
                                            progressBar.setVisibility(View.GONE);
                                        }else {
